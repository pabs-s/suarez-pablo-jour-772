...
- Which counties reported the most sewer overflows over the dataset's observed period of time? d

- Which counties had the most severe sewer overflows (by quantity, time or both) and when did they occur? Follow-up: Which reported incidents were highest in terms of overflow that was not collected?

- What is the average quantity of gallons of sewer overflows per event versus the estimated net in gallons? d

- Can I find the percentage of reported overflows by county? (Imaginary Example: Wicomico County accounted for 15% of sewer overflows in the state.) d

- What are the most common types of sewer overflows? Follow-up: Could I do a percentage breakdown of this as well? d

- Which Maryland watersheds have been most impacted by sewer overflows? d

- (Further Research Question) How might the frequency or severity of these overflows compare with Maryland rainfall data?
...
A group_by, summarise and filtering of "NA" results led me to acquiring the count of incidents occurring in specific watersheds. The highest amount was "Unknown" watersheds, followed by George's Creek as the highest named watershed.
