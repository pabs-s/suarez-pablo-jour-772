...
**Answer**
It's a dataframe with four columns: state names (state), education spending per pupil in 2021 (per_pupil_2021), the percentage growth in Gross Domestic Product in 2021 (gdp_growth_2021), and the winner of the state's popular vote in the 2020 presidential election (vote_2020).
...
**Answer**
It gives us a scatterplot with a line of best fit that seems to suggest that there is a slight positive correlation between gdp growth and population change.
...
**Answer**
In my opinion, I would have said there was no correlation between the two factors. However, the line of best fit suggest that there is potentially an extremely slight negative relationship.
...
**Answer**
The p-value was listed at 0.00301, which means that probability of the observed difference between groups is by chance. The correlation was listed at -0.4112291, showing a negative relationship. It also showed the degrees of freedom at 48 and the t test at -3.1256.
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer**
The r value being -0.06 suggests an extremely weak negative relationship, if at all. The p-value was 0.6795, making it more probable that the observed difference between the groups is not by chance. However, it's still not extremely confident.
...
**Answer**
The table suggests that average GDP growth was higher in states that Biden won, as well as the average amount of per-pupil education spending. However, states taht Trump won had higher population growth.
...
**Answer**
I see a t-value of -1.828 and a p-value of 0.07411. The p-value suggests an even stronger possibility that the observed difference between the groups is not by chance. The t-value suggests that a larger difference exists between the data sets.
...
**Task** Run the following code. Describe the output. What do you see?
**Answer**
I see a t-score of 4.2494 and a p-value of 0.0001289. The t-score is strong. The p-value, however, is incredibly low, suggesting that it's most likely random.
