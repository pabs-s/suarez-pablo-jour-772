...
**Answer**
It looks like the data frame we created in the previous lab from scraping the Cardin site. This one has added a column containing story text.
```{r}
...
**Answer**
It removes duplicate values. Dog and dog were kept because the capitalized word is considered a unique value.
```{r}
...
**Answer**
Every unique word is in its own row within one column.
```{r}
...
**Answer**
It's showing a bar chart of the most frequently used words. The results aren't too surprising given that these words would probably be the most common words in any story or communication.
...
**Answer**
It's definitely more interesting than before. Health is now the most frequently used word.
...
**Answer**
The top word in each year is health, project and act. It's interesting to see the percentage breakdown of frequency that they're used.
...
**Task** Run the following code and describe the results.
**Answer**
Now we're getting two-word strings. Covid-19 was the most frequently used bigram. Then, human rights, 19 pandemic, rescue plan and american rescue.
...
**Task** Run the following code and describe the results.
**Answer**
The top five bigrams used most frequently in 2022 are project location, amount included, health care, covid 19 and prince george's.
...
**Task** Run the following code and describe the results.
**Answer**
The top five two-word phrases shown for this year are human rights, equal rights, health care, tax credit and oral health.
...
**Answer**
They seem intuitive to me for the most part. You could argue a word like "critical" doesn't necessarily carry a negative sentiment, but I could go either way on it.
