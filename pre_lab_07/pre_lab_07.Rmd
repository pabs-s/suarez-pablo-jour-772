...
```{r echo=FALSE}
census_api_key("eee0a328f753e1c761e67084c615695762382954", install=TRUE)
```
...
**Answer**
The state with the largest percent change was Nevada.
...
Median household income by county in Maryland
...
**Answer**
No, it's not a significant difference.
...
**Answer**
Baltimore (city) had the highest percent change in median income, followed by Allegany and Calvert counties. None of the counties in the dataset saw their incomes fall within the observed timeframe.
...
**Answer**
Do lower income counties also have a lower percentage of high school graduates enrolling in college? 

Something that would make it harder to interpret is that we only have one year worth of data. This would be better showcased through more data.
...
**Answer**
The second dataset with less than 40% of graduates enrolling in college had a moderately higher count than the first dataset. The first dataset's average income was almost double that of the second dataset.
...
**Answer**
Which zip codes have the highest average income and which high schools within those zip codes have the highest graduate enrollment rates? 
