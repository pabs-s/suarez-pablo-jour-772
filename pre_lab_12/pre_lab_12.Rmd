...
**Answer** 
It's now only showing us the results for one of the tables.
```{r}
...
**Answer** 
We may want to know the author name, the county that the story primarily takes place in and potential views.
```{r}
...
**Answer** 
The output shows us 20 results. However, at the top of the results it says "xml_nodeset (122)" which leads me to believe that 122 is our total number of <li> tags and at least 2 <ul> tags.
```{r}
...
**Answer** 
The output shows us anything that seems to have a link, whether that be the releases, drop down menus or social media links.
```{r}
...
**Answer** 
It organized all of our html links into a one-column dataframe.
```{r}
