...
**Answer: This code is counting the number of courses that are in each term**
...
**Answer: The list is organized from highest to lowest "count_classes"**
...
**Answer: The data is organized by two columns, first by term and then by department. There's also more detail than the first codeblock.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer: This codeblock is organized by total_seats in descending order.**
...
**Answer: The columns are arranged in descending order based on total_seats. There are now two extra columns based on the mean and median of the seat column. The top terms all share a mean greater than 40 and a median greater than or equal to 20.**
...
**Answer: The data is now grouped by department and listed in descending order for total_seats within each department. We've also added the min and max functions.**
...
**Answer**
1. What occurred between terms 202212 and 201805 that lead to a significant increase in the total number of seats offered?

2. Why does the number of classes keep increasing with each term and how long might that trend continue?

3. Why are the terms classified the way they are? Are they based on some sort of date?
